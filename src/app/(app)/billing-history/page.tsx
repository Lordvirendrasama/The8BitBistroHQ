                                                    ...
                                                    {bill.members.map((member, mIdx) => {
                                                        ...
                                                        return (
                                                            <div key={mIdx} className="bg-background rounded-xl border-2 p-3 flex flex-col gap-2 shadow-sm">
                                                                ...
                                                                <div className="flex items-center justify-between bg-muted/20 p-2 rounded-lg border-2 border-dashed">
                                                                    ...
                                                                    <div className="flex flex-col items-center flex-1">
                                                                        <span className="text-[7px] font-black text-muted-foreground uppercase opacity-50">Log Out</span>
