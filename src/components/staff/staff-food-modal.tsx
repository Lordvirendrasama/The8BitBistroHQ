...
import type { FoodItem, BillItem, Employee } from '@/lib/types';
...
import { PlusCircle, MinusCircle, ShoppingBag, Utensils, Search, AlertTriangle, ShieldCheck } from 'lucide-react';
