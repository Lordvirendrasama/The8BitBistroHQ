    ...
    <Card className="border-2 border-dashed bg-muted/5">
      <CardHeader className="text-center py-12 flex flex-col items-center gap-4">
        ...
        <div className="space-y-1">
          <CardTitle className="text-xl font-headline tracking-tight uppercase">Registry Relocated</CardTitle>
          <CardDescription className="text-sm text-muted-foreground uppercase font-bold tracking-normal max-w-sm mx-auto">
        ...
        <Button asChild className="mt-4 font-bold uppercase tracking-normal h-12 px-8 shadow-lg">
          <Link href="/leaves">
            Open Leaves Tracker
